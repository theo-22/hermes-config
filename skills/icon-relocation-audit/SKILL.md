...
- **Project Rooms stay.** `/Users/ted/Projects/` [orphaned-ref 2026-08-21: Projects retired, superseded by Commons] remains authoritative until explicit cutover per migration docs. Do not remap. **Update:** Project Rooms now live at `/Volumes/Extra/Substrate/Commons/<Room>/`.
...
| Project_Rooms_Industrial_Family | `/Users/ted/Projects/<Room>/` [orphaned-ref 2026-08-21: Projects retired, now `/Volumes/Extra/Substrate/Commons/<Room>/`] | ❌ Not relocated — leave as-is per migration docs | Project Rooms stay ~/ authority (superseded — see Commons) |
...
- **Do NOT remap Project Rooms.** The migration docs explicitly say "/Users/ted/Projects remain current authority until explicit cutover." [orphaned-ref 2026-08-21: Projects has since been retired; Project Rooms now live at `/Volumes/Extra/Substrate/Commons/<Room>/`.]
