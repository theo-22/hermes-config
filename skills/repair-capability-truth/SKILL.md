...
description: "Reconcile a role's live callable capability, enforced access, scope declarations, docs, and typed query mappings. Use when fresh-session proof contradicts capability docs, or connected apps are conflated with actual calls. Does not authorize permission expansion."
metadata:
  category: meta
  write_mode: file
