...
- **The prompt file is in the project home.** The update prompt itself lives at `/Volumes/Extra/Substrate/Substrate_v14/System 14 Update Prompt.md`. It should remain as-is; this skill is the portable version.
